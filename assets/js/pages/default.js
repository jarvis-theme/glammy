define(['jquery','bootstrap','fancy_select','jq_ui','jq_sticky','noty'], function($)
{
	return new function(){
		var self = this;
		self.run = function(){
	    ...
	    var loveList = function(){
			/*-----------------------------------------------------------------------------------*/
			/*	LOVE LIST
			/*-----------------------------------------------------------------------------------*/
			$(document).ready(function() {
				$('.love_list .cart').slideUp(1);
				$('.love_list_btn').click(function(){
					$('.love_list .cart').slideToggle();
					$('.love_list .cart').parent().toggleClass('cart_active');
				});
			});	    	
	    };
	    ...
	    var searchForm = function(){
			...
			/*-----------------------------------------------------------------------------------*/
			$(document).ready(function() {
				$('.top_search_form form').slideUp(1);
				$('.top_search_btn').click(function(){
					$('.top_search_form form').slideToggle();
					$('.top_search_form form').parent().toggleClass('form_active');
				});
			});	    	
	    };
	    ...
	    var parralax = function(){
			...
			$(window).load(function() {
				if ($(window).width() > 1025){
					$('.flexslider.top_slider .slides li').parallax("50%", -0.5);
